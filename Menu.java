...
public class Menu 
{
	...
	public static void addHandGuard()
	{
		...
		// change to sub menu (9colors)
		handGuardStandard = new JMenu("Standard");
		handGuardStandard.add(addNewMenuItem(16,1,1));
		handGuardStandard.add(addNewMenuItem(16,1,2));
		handGuardStandard.add(addNewMenuItem(16,1,3));
		handGuardStandard.add(addNewMenuItem(16,1,4));
		handGuardStandard.add(addNewMenuItem(16,1,5));
		handGuardStandard.add(addNewMenuItem(16,1,6));
		handGuardStandard.add(addNewMenuItem(16,1,7));
		handGuardStandard.add(addNewMenuItem(16,1,8));
		//handGuardStandard.add(addNewMenuItem(16,1,9));
		handGuardMenu.add(handGuardStandard);
		// change to sub menu (9colors)
		handGuardVented = new JMenu("Vented");
		handGuardVented.add(addNewMenuItem(16,2,1));
		handGuardVented.add(addNewMenuItem(16,2,2));
		handGuardVented.add(addNewMenuItem(16,2,3));
		handGuardVented.add(addNewMenuItem(16,2,4));
		handGuardVented.add(addNewMenuItem(16,2,5));
		handGuardVented.add(addNewMenuItem(16,2,6));
		handGuardVented.add(addNewMenuItem(16,2,7));
		handGuardVented.add(addNewMenuItem(16,2,8));
		//handGuardVented.add(addNewMenuItem(16,2,9));
		handGuardMenu.add(handGuardVented);
		// change to sub menu (9colors)
		handGuardCutout = new JMenu("Cutout");
		handGuardCutout.add(addNewMenuItem(16,3,1));
		handGuardCutout.add(addNewMenuItem(16,3,2));
		handGuardCutout.add(addNewMenuItem(16,3,3));
		handGuardCutout.add(addNewMenuItem(16,3,4));
		handGuardCutout.add(addNewMenuItem(16,3,5));
		handGuardCutout.add(addNewMenuItem(16,3,6));
		handGuardCutout.add(addNewMenuItem(16,3,7));
		handGuardCutout.add(addNewMenuItem(16,3,8));
		//handGuardCutout.add(addNewMenuItem(16,3,9));
		handGuardMenu.add(handGuardCutout);
